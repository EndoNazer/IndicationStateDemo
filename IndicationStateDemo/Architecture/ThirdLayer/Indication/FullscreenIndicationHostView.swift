...
final class FullscreenIndicationHostView: UIView {
    var enableBackgroundColor: Bool = true
    var customBackgroundColor: UIColor?

    private var cache: [FullscreenIndicationKey: FullscreenIndicationViewProvider] = [:]
    ...
    func registrate(provider: FullscreenIndicationViewProvider, for key: FullscreenIndicationKey) {
        cache[key] = provider
    }

    func displayView<T>(for key: FullscreenIndicationKey, inputData: T) {
